  ...
  return (
    <div className='relative container mx-auto px-4 my-6'>
        ...
        <div className='flex items-center gap-4 md:gap-6 overflow-x-scroll scrollbar-none transition-all' ref={scrollElement}>
            <button className='bg-white rounded-full shadow-md p-1 absolute left-0 text-lg hidden md:block z-10' onClick={scrollLeft}><FaAngleLeft/></button>
            <button className='bg-white rounded-full shadow-md p-1 absolute right-0 text-lg hidden md:block z-10' onClick={scrollRight}><FaAngleRight/></button>
        {   loading ? (
